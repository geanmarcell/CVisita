...
export const TipsSection: React.FC<TipsSectionProps> = ({ data }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-8 text-left">
      {/* Main Title Banner */}
      <div className="bg-gradient-to-r from-amber-950 via-zinc-900 to-zinc-900 border border-amber-500/30 rounded-2xl p-6 sm:p-8 shadow-xl space-y-3">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30 text-xs sm:text-sm font-bold uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-white text-base sm:text-lg md:text-xl">1. Cartão Digital no Celular</h3>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-white text-base sm:text-lg md:text-xl">2. Abordagem Natural no Veículo</h3>
          </div>
          <p className="text-xs sm:text-sm md:text-base text-zinc-300 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-white text-base sm:text-lg md:text-xl">3. Chave PIX Rápida e Transparência</h3>
          </div>
          <p className="text-xs sm:text-sm md:text-base text-zinc-300 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-white text-base sm:text-lg md:text-xl">4. Nichos Mais Lucrativos</h3>
          </div>
          <p className="text-xs sm:text-sm md:text-base text-zinc-300 leading-relaxed">
      ...
      <div className="space-y-5 pt-4">
        <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white flex items-center gap-3">
          ...
          {scripts.map((script, idx) => (
            <div key={idx} className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h4 className="font-bold text-amber-300 text-base sm:text-lg md:text-xl">{script.title}</h4>
                  <p className="text-xs sm:text-sm md:text-base text-zinc-400 mt-0.5">{script.description}</p>
                </div>
                <button
                  onClick={() => handleCopyScript(script.text, idx)}
                  className="px-4 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-extrabold text-xs sm:text-sm md:text-base flex items-center gap-2 cursor-pointer transition-all self-start sm:self-auto border border-zinc-700"
                >
                  {copiedScript === idx ? (
              ...
              <div className="p-4 rounded-xl bg-zinc-950 font-mono text-xs sm:text-sm md:text-base text-zinc-300 whitespace-pre-wrap border border-zinc-800 leading-relaxed">
                {script.text}
              </div>
            </div>
          ))}
